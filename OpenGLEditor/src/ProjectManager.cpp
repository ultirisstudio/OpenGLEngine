...
namespace OpenGLEngine
{
	...
	void ProjectManager::OnImGuiRender(ContentBrowserPanel& contentBrowserPanel)
	{
		...
		if (m_OpenProjectDialog)
		{
			...
			if (ImGui::BeginPopupModal("Open project"))
			{
				...
				{
					OpenProjectFromPath(tempProjectPath, contentBrowserPanel);
	...
	void ProjectManager::OpenProjectFromPath(const std::string& projectPath, ContentBrowserPanel& contentBrowserPanel)
	{

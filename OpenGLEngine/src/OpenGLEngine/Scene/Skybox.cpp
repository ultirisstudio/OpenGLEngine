...
namespace OpenGLEngine
{
	...
	Skybox::Skybox()
	{
		...
		m_BackgroundShader.LoadFromFile("Shaders/background.vert", "Shaders/background.frag");
		m_PrefilterShader.LoadFromFile("Shaders/cubemap.vert", "Shaders/prefilter.frag");
		m_BrdfShader.LoadFromFile("Shaders/brdf.vert", "Shaders/brdf.frag");
		...
		float* data = stbi_loadf("Assets\\HDR\\NightEnvironmentHDRI008_4K-HDR.hdr", &width, &height, &nrComponents, 0);
		if (data)
		{

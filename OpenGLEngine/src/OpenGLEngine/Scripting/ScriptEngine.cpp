...
namespace OpenGLEngine
{
	...
	void ScriptEngine::InitMono()
	{
		...
		s_Data->CoreAssembly = LoadCSharpAssembly("Scripts/OpenGLEngine-ScriptCore.dll");
		PrintAssemblyTypes(s_Data->CoreAssembly);

		MonoImage* assemblyImage = mono_assembly_get_image(s_Data->CoreAssembly);
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "OpenGLEngine", "Main");

		// Create an instance of the Main class / Call the Main method

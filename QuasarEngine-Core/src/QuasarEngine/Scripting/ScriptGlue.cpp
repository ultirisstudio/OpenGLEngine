...
#include <QuasarEngine/Physic/Raycast.h>
...
#define ADD_INTERNAL_CALL(Name) mono_add_internal_call("QuasarEngine.InternalCalls::" #Name, Name)
	...
	static void RegisterComponent()
	{
		([]()
		{
			...
			std::string managedTypename = "QuasarEngine." + std::string(structName);
